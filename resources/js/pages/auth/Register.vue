<template>
    ...
    <div class="w-full min-h-screen p-10 bg-white inline-flex justify-center items-start gap-10">
        <!-- Form -->
        <div data-property-1="Register" class="w-[600px] self-stretch p-16 bg-white rounded-[60px] shadow-xl flex flex-col justify-start items-center gap-10">
            ...
            <div data-property-1="Sign In Button Select" class="w-96 px-1.5 py-1 rounded-[999px] outline outline-1 outline-offset-[-1px] outline-[#E5E7EB] inline-flex justify-center items-start gap-2.5">
                <Link :href="route('login')" data-color="Green" data-size="Default" data-state="Default" data-style="Solid" class="flex-1 flex justify-center items-center">
                    <div data-badge="false" class="flex-1 px-4 py-3.5 bg-white rounded-[999px] flex justify-center items-center gap-2.5 overflow-hidden">
                        <div class="text-center justify-start text-[#84CC16] text-base font-semibold tracking-tight">Sign In</div>
                    </div>
                </Link>
                <div  data-color="Light" data-size="Default" data-state="Default" data-style="Solid" class="flex-1 flex justify-center items-center">
                    <div data-badge="false" class="flex-1 px-4 py-3.5 bg-[#84CC16] rounded-[999px] flex justify-center items-center gap-2.5 overflow-hidden">
                        <div class="text-center justify-start text-white text-base font-semibold tracking-tight">Register</div>
                    </div>
                </div>
            </div>

            <div class="self-stretch flex flex-col justify-start items-start gap-3">
                <div class="justify-start text-[#1F2937] text-5xl font-bold leading-[60px]">Register</div>
                <div class="justify-start text-[#6B7280] text-lg font-medium leading-7">Join Us! Create Your Account to Get Started.</div>
            </div>
            ...
            <form @submit.prevent="submit" class="self-stretch flex flex-col justify-start items-start gap-5 w-full">
                ...
                <div class="self-stretch flex flex-col justify-start items-start gap-2.5">
                    <div class="self-stretch inline-flex justify-start items-start">
                        <label for="name" class="flex-1 justify-start text-[#374151] text-sm font-semibold tracking-tight">Nama Lengkap</label>
                    </div>
                    <div class="self-stretch bg-Basic-Forms-Input-Background-Bg-Color rounded-[999px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-[#D1D5DB] inline-flex justify-start items-center overflow-hidden">
                        <div class="flex-1 flex justify-start items-center">
                            <div class="flex-1 px-5 py-5 flex justify-start items-start gap-2.5">
                                <input
                                    type="text"
                                    id="name"
                                    v-model="form.name" 
                                    ...
                                    class="flex-1 w-full text-[#9CA3BA] text-base font-medium tracking-tight bg-transparent focus:ring-0 border-0 w-full"
                                    />
                            </div>
                        </div>
                    </div>
                ...
                <!-- Konfirmasi Password -->
                <div class="self-stretch flex flex-col justify-start items-start gap-2.5">
                    <label for="password_confirmation" class="self-stretch justify-start text-[#374151] text-sm font-semibold tracking-tight">Konfirmasi Password</label>
                    <div class="self-stretch bg-Basic-Forms-Input-Background-Bg-Color rounded-[999px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-[#D1D5DB]  flex items-center overflow-hidden relative">
                        <input
                ...
                <button type="submit" :disabled="form.processing" class="self-stretch px-5 py-5 bg-[#84CC16] rounded-[999px] flex justify-center items-center gap-2.5 overflow-hidden mt-5 text-white text-base font-semibold tracking-tight disabled:opacity-75">
                ...
                <div v-if="form.errors && Object.keys(form.errors).length > 0 && !form.errors.email && !form.errors.password && !form.errors.name && !form.errors.password_confirmation" class="mt-2 p-3 border border-red-300 bg-red-50 text-red-700 rounded-md text-sm self-stretch">
        ...
        <div class="flex-1 self-stretch py-16 relative rounded-3xl inline-flex flex-col justify-between items-center overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center gap-2 mb-auto px-4 max-w-xl">

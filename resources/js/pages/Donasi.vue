...
<div class="relative bg-[#ffffff]">
    ...
    <section class="relative w-full">
        <!-- Background Image -->
    <div class="w-full px-24 pt-6 relative bg-Background-Body inline-flex flex-col justify-start items-center gap-14">
        ...
        <div class="flex justify-center items-center h-[800px] px-10 gap-[100px] relative z-10">
            <!-- Kiri: Teks -->
            ...
            <!-- Kanan: Gambar QRIS -->
            <div class="w-[400px]">
                <img src="/images/qris.svg" alt="QRIS" class="w-full h-auto rounded-[20px] shadow-xl" />
            </div>
        </div>


    <section class="px-6 lg:px-24 pt-40">
        <!-- Footer -->
